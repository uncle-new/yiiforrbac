    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } ?>
          ...
          <?php if(\Yii::$app->user->can('rccuser/create') || \Yii::$app->user->can('rccuser/index') || \Yii::$app->user->can('rccuser/createitem')){ ?>
              <li class="treeview <?php if($controllerId=='rccuser'){echo 'active menu-open';} ?>">
                  <a href="#">
                      <i class="fa fa-group"></i>
                      <span>用户管理</span>
                  </a>
                  <ul class="treeview-menu">
                      <?php if(\Yii::$app->user->can('rccuser/create')){ ?>
                          <li <?php if($controllerAction=='create' && $controllerId=='rccuser'){echo 'class="active"';} ?>><a href="<?= Url::toRoute('rccuser/create') ?>"><i class="fa fa-circle-o"></i> 添加用户</a></li>
                      <?php } ?>
                      <?php if(\Yii::$app->user->can('rccuser/index')){ ?>
                          <li <?php if($controllerAction=='index' && $controllerId=='rccuser'){echo 'class="active"';} ?>><a href="<?= Url::toRoute('rccuser/index') ?>"><i class="fa fa-circle-o"></i> 用户列表</a></li>
                      <?php } ?>
                  </ul>
              </li>
          <?php } ?>
